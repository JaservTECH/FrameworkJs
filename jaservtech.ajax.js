...
function ObjectForm(){
  ...
  varObjectForm[this.idVar]['frame-func-resp']=function(a){ 
  //alert(a)
  };
  var b = this.idVar;
  ...
  this.isAvailabelContentForm = function(name){
    return document.getElementById(this.idForm).querySelector("input[name='"+name+"']") != null;
  }
